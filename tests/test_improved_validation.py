    ...
    def test_invalid_ticker_formats(self):
        ...
        for ticker in invalid_tickers:
            try:
                ...
                pytest.fail(f"Ticker '{ticker}' should have been rejected but was accepted")
