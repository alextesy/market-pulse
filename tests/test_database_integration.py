...
class TestDatabaseSchemaAlignment:
    ...
    def test_article_ticker_dto_to_dict(self):
        ...
        article_ticker = ArticleTickerDTO(article_id=1, ticker="AAPL", confidence=0.85)
    ...
    def test_embedding_dto_to_dict(self):
        ...
        embedding_dto = EmbeddingDTO(article_id=1, embedding=embedding)
    ...
    def test_complete_workflow(self):
        ...
        embedding = EmbeddingDTO(article_id=1, embedding=[0.1] * 384)
