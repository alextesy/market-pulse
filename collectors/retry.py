            ...
            for attempt in range(1, max_tries + 1):
                try:
                    ...
                    if (
                        ...
                        and result.status_code in retriable_codes
                    ):
                    ...
                    is_retriable = type(e) in retriable_exceptions or (
                        hasattr(e, "response")
    ...
    def get(self, url: str, **kwargs) -> httpx.Response:
        ...
        try:
            ...
            self.requests_total.labels(
                source=self.source_name, code=response.status_code
            ).inc()
            ...
            self.requests_total.labels(source=self.source_name, code=status_code).inc()
