    ...
    try:
        ...
        logger.info(
            ...
            extra={
                ...
                "items_per_second": len(items) / fetch_duration if fetch_duration > 0 else 0,
            }
        )
        ...
        logger.info(
            ...
            extra={
                ...
                "items_per_second": len(items) / write_duration if write_duration > 0 else 0,
            }
        )
...
def test_data_quality_validation() -> None:
    ...
    test_items = [
        ...
        IngestItem(
            ...
            published_at=datetime.now(timezone.utc) + timedelta(minutes=10),  # Future publish date
            retrieved_at=datetime.now(timezone.utc),
            title="Bad",  # Too short
