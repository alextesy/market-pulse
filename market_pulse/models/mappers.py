...
from .dto import IngestItem, ArticleDTO, ArticleTickerDTO, TickerLinkDTO, SignalContribDTO
...
def ticker_link_to_article_ticker(link: TickerLinkDTO, article_id: int) -> ArticleTickerDTO:
